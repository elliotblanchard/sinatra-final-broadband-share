...
contract_a = Contract.create(name: "contract_a", provider_id: provider_a.id, wifi_name: "wifi_a", wifi_password: "pw_a", duration_days: "23", approved: "1")

contract_b = Contract.create(name: "contract_b", provider_id: provider_b.id, wifi_name: "wifi_b", wifi_password: "pw_b", duration_days: "14", approved: "0")

contract_c = Contract.create(name: "contract_c", provider_id: provider_c.id, wifi_name: "wifi_c", wifi_password: "pw_c", duration_days: "99", approved: "0")

contract_d = Contract.create(name: "contract_d", provider_id: provider_d.id, wifi_name: "wifi_d", wifi_password: "pw_d", duration_days: "31", approved: "1")
